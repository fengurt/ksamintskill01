...
export function agentBrief(runId) {
  ...
  return [
    ...
    `3. Run:`,
    `   python3 skills/longdoc2mdpages/scripts/estimate-fit.py --work ${run.path} --write --fail-on overfull`,
    `   python3 skills/longdoc2mdpages/scripts/check-coverage.py --stage outline --work ${run.path}`,
    `   python3 skills/longdoc2mdpages/scripts/check-coverage.py --stage deck --work ${run.path}`,
