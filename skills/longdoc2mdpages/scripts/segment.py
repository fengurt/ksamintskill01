#!/usr/bin/env python3
"""Segment a Markdown document into atomic units for longdoc2mdpages.
...
def main(argv: Iterable[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Segment Markdown into longdoc2mdpages units")
