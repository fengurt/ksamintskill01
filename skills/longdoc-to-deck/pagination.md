...
External reference for **stage c** of `longdoc-to-deck`. Load only when paginating.
...
## Role picker (same 12 as md-to-html-slides L2 jobs)
...
Matches `md-to-html-slides` pipeline:
